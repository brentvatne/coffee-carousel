...
(function($) {
  $.mbScrollable= {
    ...
    defaults:{
      ...
      scrollTimer:6000,
      pageClass: "page",
      pageIndexClass: "pageIndex",
      hideIfPageSizeOne: true,
    ...
    mbPageIndex: function(){
      var mbScrollable= $(this).get(0);
      var controls=$(mbScrollable.options.controls);
      var wrapper=$(mbScrollable.options.wrapper);
      var pages=wrapper.find("." + mbScrollable.options.pageIndexClass);
      if (pages){
        function getPage(i){
        ...
        for(var i=1;i<=mbScrollable.totalPages;i++){
          n++;
          var p=$("<span class='" + mbScrollable.options.pageClass + "'><span> " + n + "</span><\/span>").bind("click",function(){
            getPage($("span", this).html());
            $(mbScrollable).mbStopAutoscroll();
            mbScrollable.autoScrollActive=false;
          });
          pages.append(p);
    ...
    mbManageControls: function(){
      ...
      var controls=$(mbScrollable.options.controls);
      var wrapper=$(mbScrollable.options.wrapper);
      if (mbScrollable.elements.size()<=mbScrollable.options.elementsInPage && mbScrollable.options.hideIfPageSizeOne == true){
        controls.hide();
      }else{
        controls.fadeIn();
      }
      ...
      wrapper.find("." + mbScrollable.options.pageClass).removeClass("sel");
      wrapper.find("." + mbScrollable.options.pageClass).eq(mbScrollable.idx-1).addClass("sel");
